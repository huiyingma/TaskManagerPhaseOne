 ...
 */
public class TaskCoachingModel implements Serializable {

    private static final long serialVersionUID = 1L;

    /** The activities in this instance of the coaching task. */
    ...
    /** Guillermo: keep a Content Manager with the resources for the run  */
    private com.silsglass.coachingmodel.TaskContentManager mContentMng;
    
    /** Constructs a new model with the specified list of phrases. */
    public TaskCoachingModel(List<String> phrases) {
    ...
    // created by Guillermo. To allow the user to go backwards in the list of activities.
    private boolean previous() {
        if (getCurrentPhraseIndex() != 1) {
            do {
                mCurrentPhrase = (mCurrentPhrase - 1) % mPhrases.length;
            } while (mGuessedPhrases[mCurrentPhrase]);
            return false;
