 ...
 */
public class RunResultsActivity extends Activity {

    /**
     * The intent extra that holds the instance of {@link TaskCoachingModel} to display in the
     * results.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TaskCoachingModel model = (TaskCoachingModel) getIntent().getSerializableExtra(EXTRA_MODEL);
        ...
        mCardScroller.setAdapter(
                new RunResultsAdapter(getLayoutInflater(), getResources(), model));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.run_results, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.run_task) {
