...
/**
 * The initial splash screen activity in the task that displays a "Get ready" prompt and allows
 * the user to tap to access the instructions.
 */
public class StartCoachingTask extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.start_coaching_task, menu);
        return true;
    }
    ...
    /**
     * Starts the task as a RUN, and finishes this activity so that the user is not returned
